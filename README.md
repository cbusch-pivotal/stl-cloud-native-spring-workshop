...
#### _Session 6: Route Services with Apigee_ [(Slides)](session_06/Session_06_Route_Services.pdf)
  - [Lab 12a - PCF Route Service with Apigee](http://docs.apigee.com/api-services/content/creating-edge-api-proxy-manage-client-calls-your-cloud-foundry-application)
  - [Lab 12b - CF Custom Route Service Examples](https://docs.cloudfoundry.org/services/route-services.html#examples)
