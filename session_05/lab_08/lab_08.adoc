...
----
$cf api
API endpoint: https://api.cfapps.io (API version: 2.43.0)
----
...
+
----
$cf set-env hello-server CF_TARGET https://api.cfapps.io
Setting env variable 'CF_TARGET' to 'https://api.cfapps.io' for app hello-server in org instructor-org / space development as instructor...
OK
...
+
----
$cf set-env hello-ui CF_TARGET https://api.cfapps.io
Setting env variable 'CF_TARGET' to 'https://api.cfapps.io' for app hello-ui in org instructor-org / space development as instructor...
OK
TIP: Use 'cf restage' to ensure your env variable changes take effect
----
